...
//	  }
	...
	public void testaddFilebutton() throws Exception {
		...
		YDFFileFunction.getBrowser(driver)
				.sendKeys("C:\\Test\\satabdi.jana+test09@yourdigitalfile.com.au-www.yourdigitalfile.com.au.ydf");
	...
	public void testNewFile() throws Exception {
		...
		if (driver.findElement(By.xpath(
				"/html/body/div[3]/div[1]/div/div[4]/div/div[2]/div[2]/div/div[4]/div/table/tbody/tr[2]/td[2]/div/span"))
				.getText().equals("File1")) {
